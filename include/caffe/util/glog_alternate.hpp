#ifndef CAFFE_UTIL_GLOG_ALTERNATE_H_
#define CAFFE_UTIL_GLOG_ALTERNATE_H_
...
class LogMessage{
	...
	public:
		LogMessage(const std::string &l)
			:level(l), ofs(_enable ? std::cerr : __nullstream) {
			stream() << "[" << level << "]\t";
		}
...
#endif  // use glog alternate

#endif  // CAFFE_UTIL_GLOG_ALTERNATE_H_
