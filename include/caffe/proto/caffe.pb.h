...
class ImageDataParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_data_from_disk() const;
  inline void clear_data_from_disk();
  static const int kDataFromDiskFieldNumber = 11;
  inline bool data_from_disk() const;
  inline void set_data_from_disk(bool value);
 ...
 private:
  ...
  inline void set_has_data_from_disk();
  inline void clear_has_data_from_disk();
...
// optional bool data_from_disk = 11 [default = true];
inline bool ImageDataParameter::has_data_from_disk() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ImageDataParameter::set_has_data_from_disk() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ImageDataParameter::clear_has_data_from_disk() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ImageDataParameter::clear_data_from_disk() {
  data_from_disk_ = true;
  clear_has_data_from_disk();
}
inline bool ImageDataParameter::data_from_disk() const {
  return data_from_disk_;
}
inline void ImageDataParameter::set_data_from_disk(bool value) {
  set_has_data_from_disk();
  data_from_disk_ = value;
}
