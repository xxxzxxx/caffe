...
class NoisyImageDataLayerTest : public MultiDeviceTest<TypeParam> {
  typedef typename TypeParam::Dtype Dtype;

 protected:
  NoisyImageDataLayerTest()
      : seed_(1701),
  ...
  virtual ~NoisyImageDataLayerTest() {
...
TYPED_TEST_CASE(NoisyImageDataLayerTest, TestDtypesAndDevices);
