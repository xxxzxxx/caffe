...
void protobuf_AssignDesc_caffe_2fproto_2fcaffe_2eproto() {
  ...
  static const int SolverParameter_offsets_[28] = {
  ...
  static const int NetStateRule_offsets_[4] = {
  ...
  static const int LayerParameter_offsets_[34] = {
  ...
  AccuracyParameter_descriptor_ = file->message_type(10);
  ...
  static const int ConvolutionParameter_offsets_[14] = {
  ...
  static const int ImageDataParameter_offsets_[11] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ImageDataParameter, data_from_disk_),
  };
  ...
  SliceParameter_descriptor_ = file->message_type(30);
  ...
  WindowDataParameter_descriptor_ = file->message_type(31);
  ...
  V0LayerParameter_descriptor_ = file->message_type(32);
...
void protobuf_AddDesc_caffe_2fproto_2fcaffe_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "state\030\006 \001(\0132\017.caffe.NetState\"\226\006\n\017SolverP"
    "arameter\022\013\n\003net\030\030 \001(\t\022&\n\tnet_param\030\031 \001(\013"
    "2\023.caffe.NetParameter\022\021\n\ttrain_net\030\001 \001(\t"
    "\022\020\n\010test_net\030\002 \003(\t\022,\n\017train_net_param\030\025 "
    "\001(\0132\023.caffe.NetParameter\022+\n\016test_net_par"
    "am\030\026 \003(\0132\023.caffe.NetParameter\022$\n\013train_s"
    "tate\030\032 \001(\0132\017.caffe.NetState\022#\n\ntest_stat"
    "e\030\033 \003(\0132\017.caffe.NetState\022\021\n\ttest_iter\030\003 "
    ...
    "\0132\023.caffe.NetStateRule\022-\n\004type\030\005 \001(\0162\037.c"
    "affe.LayerParameter.LayerType\022\037\n\005blobs\030\006"
    " \003(\0132\020.caffe.BlobProto\022\016\n\005param\030\351\007 \003(\t\022<"
    "\n\017blob_share_mode\030\352\007 \003(\0162\".caffe.LayerPa"
    ...
    "u_param\030\036 \001(\0132\024.caffe.ReLUParameter\0225\n\021w"
    "indow_data_param\030\024 \001(\0132\032.caffe.WindowDat"
    "aParameter\0222\n\017threshold_param\030\031 \001(\0132\031.ca"
    "ffe.ThresholdParameter\0223\n\020hinge_loss_par"
    "am\030\035 \001(\0132\031.caffe.HingeLossParameter\022*\n\013s"
    ...
    "Parameter.DB:\007LEVELDB\"\033\n\002DB\022\013\n\007LEVELDB\020\000"
    "\022\010\n\004LMDB\020\001\".\n\020DropoutParameter\022\032\n\rdropou"
    "t_ratio\030\001 \001(\002:\0030.5\"\177\n\022DummyDataParameter"
    ...
    "\013slice_point\030\002 \003(\r\"\215\002\n\023WindowDataParamet"
    "er\022\016\n\006source\030\001 \001(\t\022\020\n\005scale\030\002 \001(\002:\0011\022\021\n\t"
    "mean_file\030\003 \001(\t\022\022\n\nbatch_size\030\004 \001(\r\022\024\n\tc"
    ...
    "\030\017 \001(\002:\0040.75\022\016\n\006source\030\020 \001(\t\022\020\n\005scale\030\021 "
...
const int ImageDataParameter::kDataFromDiskFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_data_from_disk;
        break;
      }

      // optional bool data_from_disk = 11 [default = true];
      case 11: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_data_from_disk:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &data_from_disk_)));
          set_has_data_from_disk();
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectAtEnd()) return true;
...
void ImageDataParameter::SerializeWithCachedSizes(
  ...
  // optional bool data_from_disk = 11 [default = true];
  if (has_data_from_disk()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(11, this->data_from_disk(), output);
  }
...
::google::protobuf::uint8* ImageDataParameter::SerializeWithCachedSizesToArray(
  ...
  // optional bool data_from_disk = 11 [default = true];
  if (has_data_from_disk()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(11, this->data_from_disk(), target);
  }
...
void ImageDataParameter::MergeFrom(const ImageDataParameter& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_data_from_disk()) {
      set_data_from_disk(from.data_from_disk());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void ImageDataParameter::Swap(ImageDataParameter* other) {
  if (other != this) {
    ...
    std::swap(data_from_disk_, other->data_from_disk_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
