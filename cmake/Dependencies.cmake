...
if(NOT APPLE)
  ...
  set_property(CACHE BLAS PROPERTY STRINGS "Atlas;Open;MKL;Eigen;QSML")
  ...
  elseif(BLAS STREQUAL "QSML" OR BLAS STREQUAL "qsml")
    find_package(QSML REQUIRED)
    include_directories(SYSTEM ${QSML_INCLUDE_DIR})
    list(APPEND Caffe_LINKER_LIBS ${QSML_LIBRARIES})
    add_definitions(-DUSE_QSML)
  endif()
elseif(APPLE)
